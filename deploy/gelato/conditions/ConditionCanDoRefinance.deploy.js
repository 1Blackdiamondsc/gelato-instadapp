...
module.exports = async (hre) => {
  if (hre.network.name === "mainnet") {
    console.log(
      "\n\n Deploying ConditionCanDoRefinance to mainnet. Hit ctrl + c to abort"
    );
    await sleep(10000);
  }
  ...
  // the following will only deploy "ConditionCanDoRefinance"
  // if the contract was never deployed or if the code changed since last deployment
  await deploy("ConditionCanDoRefinance", {
    from: deployer,
...
module.exports.tags = ["ConditionCanDoRefinance"];
