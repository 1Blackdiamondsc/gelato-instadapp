...
module.exports = async (hre) => {
  if (hre.network.name === "mainnet") {
    console.log(
      "\n\n Deploying ConnectGelatoDebtBridgeFee to mainnet. Hit ctrl + c to abort"
    );
  ...
  if (hre.network.name === "hardhat") {
    ...
    await deploy("ConnectGelatoDebtBridgeFee", {
      from: deployer,
      args: [connectorId],
    });
    ...
    await instaConnectors
      .connect(instaMaster)
      .enable((await ethers.getContract("ConnectGelatoDebtBridgeFee")).address);
    ...
    // the following will only deploy "ConnectGelatoDebtBridgeFee"
...
module.exports.tags = ["ConnectGelatoDebtBridgeFee"];
