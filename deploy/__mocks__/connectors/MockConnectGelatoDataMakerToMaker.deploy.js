...
module.exports = async (hre) => {
  if (hre.network.name === "mainnet") {
    console.log(
      "\n\n Deploying MockConnectGelatoDataMakerToMaker to mainnet. Hit ctrl + c to abort"
    );
  ...
  if (hre.network.name === "hardhat") {
    ...
    await deploy("MockConnectGelatoDataMakerToMaker", {
      from: deployer,
      args: [
        connectorId,
    ...
    await instaConnectors
      .connect(instaMaster)
      .enable(
        (await ethers.getContract("MockConnectGelatoDataMakerToMaker")).address
      );
    ...
    // the following will only deploy "MockConnectGelatoDataMakerToMaker"
...
module.exports.tags = ["MockConnectGelatoDataMakerToMaker"];
