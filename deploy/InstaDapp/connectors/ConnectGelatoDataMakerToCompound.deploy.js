...
module.exports = async (hre) => {
  if (hre.network.name === "mainnet") {
    console.log(
      "\n\n Deploying ConnectGelatoDataMakerToCompound to mainnet. Hit ctrl + c to abort"
    );
  ...
  if (hre.network.name === "hardhat") {
    ...
    await deploy("ConnectGelatoDataMakerToCompound", {
      from: deployer,
      args: [
        connectorId,
    ...
    // the following will only deploy "ConnectGelatoDataMakerToCompound"
