...
module.exports = (route, withVaultCreation) => {
  ...
  switch (route) {
    case 0:
      ...
      break;
    case 1:
      rawGasCost = 3971000; // 2855000 * 1,1 // gas left method measure : 2855000 - 2667325 = 187675 | gas reporter : 2855000 - 2244814 = 610186
      break;
    case 2:
      rawGasCost = 3140500; // 3610000 * 1,1 // gas left method measure : 3610000 - 3423279 = 186721 | gas reporter : 3610000 - 3031103 = 578897
      break;
    case 3:
