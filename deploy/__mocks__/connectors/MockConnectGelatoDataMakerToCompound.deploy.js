...
module.exports = async (hre) => {
  if (hre.network.name === "mainnet") {
    console.log(
      "\n\n Deploying MockConnectGelatoDataMakerToCompound to mainnet. Hit ctrl + c to abort"
    );
  ...
  if (hre.network.name === "hardhat") {
    ...
    await deploy("MockConnectGelatoDataMakerToCompound", {
      from: deployer,
      args: [
        connectorId,
    ...
    await instaConnectors
      .connect(instaMaster)
      .enable(
        (await ethers.getContract("MockConnectGelatoDataMakerToCompound"))
          .address
      );
    ...
    // the following will only deploy "MockConnectGelatoDataMakerToCompound"
...
module.exports.tags = ["MockConnectGelatoDataMakerToCompound"];
