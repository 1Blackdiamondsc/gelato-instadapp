...
module.exports = async (hre) => {
  if (hre.network.name === "mainnet") {
    console.log(
      "\n\n Deploying MockConnectGelatoDataFullMakerToCompound to mainnet. Hit ctrl + c to abort"
    );
  ...
  if (hre.network.name === "hardhat") {
    ...
    await deploy("MockConnectGelatoDataFullMakerToCompound", {
      from: deployer,
      args: [
        connectorId,
    ...
    await instaConnectors
      .connect(instaMaster)
      .enable(
        (await ethers.getContract("MockConnectGelatoDataFullMakerToCompound"))
          .address
      );
    ...
    // the following will only deploy "MockConnectGelatoDataFullMakerToCompound"
...
module.exports.tags = ["MockConnectGelatoDataFullMakerToCompound"];
